...
export function createFournisseur(http: HttpClient, rootUrl: string, params: CreateFournisseur$Params, context?: HttpContext): Observable<StrictHttpResponse<Fournisseur>> {
